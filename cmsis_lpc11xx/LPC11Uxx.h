...
typedef struct {                            /*!< (@ 0x40044000) IOCONFIG Structure     */
  ...
  __IO uint32_t PIO0_10;                     /*!< (@ 0x40044028) I/O configuration for pin PIO0_9/MOSI0/CT16B0_MAT1 */
  __IO uint32_t PIO0_11;                     /*!< (@ 0x4004402C) I/O configuration for pin PIO0_9/MOSI0/CT16B0_MAT1 */
  __IO uint32_t PIO0_12;                     /*!< (@ 0x40044030) I/O configuration for pin PIO0_9/MOSI0/CT16B0_MAT1 */
  __IO uint32_t PIO0_13;                     /*!< (@ 0x40044034) I/O configuration for pin PIO0_9/MOSI0/CT16B0_MAT1 */
